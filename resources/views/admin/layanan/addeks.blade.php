...
@section('admin')
    <div class="conteinter-fluid"
        ...
        <div class="rounded-bottom-3"
            ...
            @endif
            <form action="{{ route('eksPostA') }}" method="post" enctype="multipart/form-data" class="p-2">
                @csrf
                <div class="mb-3 row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="nama_ekskul" id="nama" class="form-control">
                        ...
                        <textarea name="deksripsi" id="deksripsi" class="form-control" row="2"></textarea>
                    </div>
                </div>
