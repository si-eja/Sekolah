...
<body>
    ...
    <div class="container-fluid">
        <div class="row" style="height: 100vh;">
                ...
                <div class="offcanvas-body d-flex flex-column align-items-start align-items-lg-start text-white">
                    ...
                    <div class="d-flex flex-column align-items-start gap-2 mb-4 w-100 sidebar-menu">
                        ...
                        <div class="collapse ps-3" id="wrgskCollapse">
                            <a href="{{ route('guru') }}" class="text-style d-block mb-2">Guru</a>
                            <a href="{{ route('siswa') }}" class="text-style d-block mb-2">Siswa</a>
                        </div>
                        <!-- Layanan -->
            ...
            <!-- Konten -->
            <div class="col-lg-10 content-area" style="background-color: rgb(253, 244, 227); height: 100vh; padding-top: 3rem; overflow-y: auto;">
                @yield('admin')
            </div>
        </div>
    </div>
